...
import { MessageCircle, ChevronLeft, ChevronRight, Loader2, Copy, Facebook, Check } from 'lucide-react';
...
export default function ProductDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // 2. Fetch Related Products (Random 4 items excluding current)
      const { data: relatedData } = await supabase
        .from('products')
        .select('*')
        .neq('id', id) // Jangan tampilkan produk yang sedang dilihat
        .limit(4);     // Ambil 4 produk
