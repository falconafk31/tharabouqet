...
import { MessageCircle, ChevronLeft, ChevronRight, Loader2, Copy, Facebook, Check, CheckCircle, Image as ImageIcon } from 'lucide-react';
...
export default function ProductDetailClient({ initialProduct, initialRelated }: { initialProduct: Product, initialRelated: Product[] }) {
